...
MORGOTH can be executed as a python3 script in the console. It requires a single json-config file (see example_Json_config.txt in Example_Data folder) as input. In main.py, we depict an example usage of MORGOTH.
...
```
cd Example_Data/
python3 ../src/cp-main.py example_Json_config.json
```
